...
async getAllFlatmates() {
  ...
  // ──────────────────────────────────────────────────────────
  // GET MY FLATMATES (owned by userId)
  // ──────────────────────────────────────────────────────────

  async getMyFlatmates(userId: number) {
    return this.prisma.flatmate.findMany({
      where:   { userId },
  ...
  // ──────────────────────────────────────────────────────────
  // MARK SOLD OUT — operates on flatmate table (not property)
  // ──────────────────────────────────────────────────────────

  async markSoldOut(id: number, userId: number, reason: string) {
    // Ownership check also validates existence
    await this.checkOwner(id, userId);
